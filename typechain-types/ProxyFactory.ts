...
export declare namespace ProxyFactoryBase {
  ...
  export type MultiCallArgsStructOutput = [string, BigNumber, string] & {
    target: string;
    value: BigNumber;
    data: string;
  };
...
export interface ProxyFactoryInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "deployCreateAndRegister",
  ...
  encodeFunctionData(
    ...
    values: [ProxyFactoryBase.MultiCallArgsStruct[]]
  ): string;
...
export interface ProxyFactory extends BaseContract {
  ...
  functions: {
    ...
    getProxyImplementation(
      proxyAddress_: PromiseOrValue<string>,
      overrides?: CallOverrides
    ): Promise<[string]>;
    ...
    multiCall(
      cdata_: ProxyFactoryBase.MultiCallArgsStruct[],
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
