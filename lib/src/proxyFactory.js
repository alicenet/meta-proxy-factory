...
const ProxyFactory_json_1 = __importDefault(require("../artifacts/contracts/ProxyFactory.sol/ProxyFactory.json"));
...
class Factory {
    ...
    constructor(ethers, factoryAddress) {
        ...
        if (factoryAddress !== undefined) {
            this.factory = new this.ethers.Contract(factoryAddress, ProxyFactory_json_1.default.abi, this.ethers.provider);
        }
        else {
            this.factory = new this.ethers.Contract(this.ethers.constants.AddressZero, ProxyFactory_json_1.default.abi, this.ethers.provider);
        }
    }
    initialized() {
    ...
    async deploy(overrides) {
        let factoryBase = await this.ethers.getContractFactoryFromArtifact(ProxyFactory_json_1.default);
    ...
    async init() {
        if (this.factory.address === this.ethers.constants.AddressZero) {
            ...
            this.factory = await this.ethers.getContractAtFromArtifact(ProxyFactory_json_1.default, this.factory.address);
        }
        this._initialized = true;
    }
    async changeFactory(factoryAddress) {
        this.factory = await this.ethers.getContractAtFromArtifact(ProxyFactory_json_1.default, factoryAddress);
        this._initialized = true;
    }
     ...
     */
    async CalculateDeployCreate2Address(factoryAddress, salt) {
        const initCode = "0x6020363636335afa1536363636515af43d36363e3d36f3";
        return this.ethers.utils.getCreate2Address(factoryAddress, this.ethers.utils.formatBytes32String(salt), this.ethers.utils.keccak256(initCode));
    }
    /**
     ...
     * @returns
     */
    async upgradeProxyGasSafe(contractName, initCallData, constructorArgs, salt, waitConfirmations = 0, overrides) {
        const ImplementationBase = await this.ethers.getContractFactory(contractName);
        try {
